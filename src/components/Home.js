        ...
        <div className="home">
            <div className="content-container">
                <div className="text-container">
                    ...
                    <p>Dive into the realm of strategic thinking and master poker strategy. Analyzing vast data with sophisticated mathematical models, our engine employs probability theory to assess odds perfectly. Witness the power of AI-driven probability decision-making with Brian's AI.</p>
